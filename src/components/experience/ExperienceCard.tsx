...
export function ExperienceCard({ experience }: ExperienceCardProps) {
  return (
    <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col">
            <div className="flex items-center gap-2">
              <h3
                className={cn(
                  'text-lg font-bold',
                  experience.isBlur ? 'blur-[6px]' : 'blur-none',
                )}
              >
                {experience.company}
              </h3>
              ...
              {experience.facebook && (
                <Tooltip>
                  ...
                  <TooltipContent>Visit Facebook</TooltipContent>
                </Tooltip>
              )}
              {experience.x && (
                <Tooltip>
      ...
      {/* Technologies */}
      <div>
        <h4 className="text-md mt-4 mb-2 font-semibold">Cybersecurity Technical Skills</h4>
